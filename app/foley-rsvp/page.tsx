...
export const metadata = generatePageMetadata({
  title: "Foley RSVP - Free Regenerative Medicine Dinner Seminar",
  description:
    "Reserve your free seat and complimentary dinner at our educational stem cell therapy seminar in Foley, AL. No surgery, no drugs, no long recovery. Seats are limited.",
  path: "/foley-rsvp",
  noIndex: true,
});
...
export default function FoleyRsvpPage() {
  return (
    <>
      <JsonLd
        data={webPageSchema({
          title: "Foley RSVP - Free Regenerative Medicine Dinner Seminar",
          description:
            "Reserve your free seat and complimentary dinner at our educational stem cell therapy seminar in Foley, AL.",
          url: "/foley-rsvp",
        })}
      />
      <JsonLd
        data={breadcrumbSchema([
          ...
          {
            name: "Foley RSVP",
            url: "https://regenerativerevival.com/foley-rsvp",
          },
        ])}
      />
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-24 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/65">
              ...
              right here on the Alabama Gulf Coast.
            </p>
            ...
            <div>
              ...
              <div className="mt-8 space-y-4 rounded-2xl border border-[#EDE8F7] bg-[#F7F5FC] p-7">
                ...
                <div className="flex items-center gap-3 text-[15px] text-[#1A1F30]">
                  ...
                  <span>
                    Date:{" "}
                    <span className="text-[#7A7F95]">Tuesday, August 11th, 2026</span>
                  </span>
                </div>
                <div className="flex items-center gap-3 text-[15px] text-[#1A1F30]">
                ...
                <div className="flex items-start gap-3 text-[15px] text-[#1A1F30]">
                  ...
                  <span>
                    ...
                    <span className="text-[#7A7F95]">
                      Main Hall at The Grove &mdash; Wolf Bay Restaurant
                      <br />
