...
// TODO: Replace with the Foley / "The Grove" event-specific TyriaCore RSVP form URL.
// Ben provides the form ID + eventContextToken for this event. The Dell Webb token
// below MUST NOT be reused — it would route Foley RSVPs to the wrong event.
export const RSVP_FORM_SRC =
  "https://www.tyriacore.app/forms/REPLACE_WITH_FOLEY_FORM_ID?workspaceId=ws_962d7611-e9b4-4990-9ddc-89bf7c899735&embed=1";
