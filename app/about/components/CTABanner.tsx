...
export default function CTABanner() {
  ...
  return (
    <section ref={ref} className="relative py-24 lg:py-28 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#345691]/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-[11px] font-medium tracking-[0.32em] text-white/60 uppercase">Transform Your Life</span>
          <span className="h-px w-8 bg-white/30" />
        </motion.div>
        ...
        <motion.h2
          ...
          className="font-[family-name:var(--font-fraunces)] font-normal text-[2.5rem] sm:text-5xl lg:text-[3.75rem] text-white leading-[1.05] tracking-[-0.02em]"
        >
        ...
        >
          Take the first step towards a healthier future with Regenerative Revival. Our carefully-vetted partners, personalized regenerative therapies, and expert team are here to help you achieve lasting pain relief and improved well-being.
        </motion.p>
        ...
        >
          <div className="flex items-center gap-1">
            ...
            <span className="ml-1.5 text-sm font-bold text-white">4.9 Rating</span>
          </div>
          ...
          <span className="h-3.5 w-px bg-white/20" />
          <span className="text-sm text-white/60">No Obligation Consultation</span>
        </motion.div>
      </div>
    </section>
  );
