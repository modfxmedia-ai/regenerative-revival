...
const posts = [
  {
    ...
    readTime: "8 min read",
    image: "https://www.regenerativerevival.com/wp-content/uploads/2024/08/pexels-karolina-grabowska-4506105-scaled.jpg",
  },
  {
    ...
    category: "Wellness",
    readTime: "5 min read",
    image: "https://www.regenerativerevival.com/wp-content/uploads/2024/08/pexels-olly-3768916-scaled.jpg",
  },
  {
    ...
    category: "Recovery",
    readTime: "6 min read",
    image: "https://www.regenerativerevival.com/wp-content/uploads/2024/08/pexels-pixabay-40751-scaled.jpg",
  },
];
    ...
    <section id="blog" className="relative py-28 bg-white overflow-hidden">
      ...
      <div ref={ref} className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <a
            href="#"
            className="group flex items-center gap-2 text-primary font-semibold hover:text-primary-dark transition-colors shrink-0"
          >
            View All Articles
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {posts.map((post, i) => (
            <motion.article
              ...
              className="group bg-white rounded-3xl overflow-hidden soft-shadow border border-sage hover:soft-shadow-lg transition-all hover:-translate-y-1 cursor-pointer"
            >
              {/* Image */}
