...
const steps = [
  ...
  { num: "02", title: "Treatment Planning", description: "A personalized treatment plan is created based on your specific needs, targeting the root cause of your pain or condition rather than just masking symptoms." },
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          {steps.map((s, i) => (
            ...
            >
              <span className="font-[family-name:var(--font-fraunces)] italic text-[4rem] leading-none text-[#6762AF]/10 group-hover:text-[#6762AF]/20 block mb-3 select-none transition-colors duration-500">
                {s.num}
              </span>
