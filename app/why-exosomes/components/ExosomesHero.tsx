...
import { Sparkles, Microscope, Zap } from "lucide-react";

export default function ExosomesHero() {
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 lg:px-8 pt-8 pb-24">
        <div className="max-w-3xl">
          ...
          >
            {[
              { icon: Microscope, label: "Nano-Sized Vesicles" },
              { icon: Sparkles, label: "Cell-Free Therapy" },
              { icon: Zap, label: "Regenerative Signals" },
            ].map((item) => (
              <div
                key={item.label}
