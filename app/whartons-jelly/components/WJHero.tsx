...
import { Dna, Leaf, ShieldCheck } from "lucide-react";

export default function WJHero() {
  return (
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 lg:px-8 pt-32 pb-24">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-sm font-medium text-white/80 font-sans">Natural Source</span>
          </motion.div>
          <motion.h1
          ...
          >
            A gelatinous substance found within the umbilical cord, rich in
            mesenchymal stem cells, growth factors, and anti-inflammatory
            properties. Discover how this remarkable natural resource is
          ...
          >
            {[
              { icon: Dna, label: "Rich in MSCs" },
              { icon: Leaf, label: "Ethically Sourced" },
              { icon: ShieldCheck, label: "Safe & Non-Invasive" },
            ].map((item) => (
