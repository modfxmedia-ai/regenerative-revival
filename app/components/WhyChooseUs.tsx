        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="lg:sticky lg:top-32">
            ...
            <div className="mt-10 relative rounded-3xl overflow-hidden soft-shadow-lg">
              ...
              <img src="https://images.pexels.com/photos/7089401/pexels-photo-7089401.jpeg?auto=compress&cs=tinysrgb&w=800" alt="Patient testimonial" className="w-full h-auto rounded-3xl object-cover aspect-video" />
          ...
          <div className="flex flex-col gap-5">
            {reasons.map((r, i) => (
              <motion.div key={r.title} initial={{ opacity: 0, x: 30 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.5, delay: 0.1 + i * 0.1 }} className="rounded-2xl p-6 bg-cream border border-gray-100 hover:border-primary/20 transition-all group">
